...
SELECT DISTINCT customers.company_name, CONCAT(employees.first_name, ' ', employees.last_name) AS "employees"
FROM customers
JOIN employees
    ON employees.city = 'London' AND customers.city = 'London'
JOIN orders
    ON orders.customer_id = customers.customer_id
JOIN shippers
    ON shippers.shipper_id = orders.ship_via AND shippers.company_name = 'United Package';
